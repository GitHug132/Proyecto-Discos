var Formulario = null;
/*funciones para los forms de la web*/
$(document).ready(function() {

    //crea los dialogos de la web y inicializa la clase Formularios
            $("#dialog").dialog({
                autoOpen: false,
...
/*clase Formularios que contiene las funciones para crear las contraseñas*/
Formulario = function () {
